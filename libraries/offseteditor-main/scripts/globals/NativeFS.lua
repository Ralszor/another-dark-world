-- This is a modified version of https://github.com/zorggn/nativefs/, with additional type hints.
-- "Maybe we should upstream this" - a certain dark place contributor (i wonder who)

local has_ffi, ffi = pcall(require, "ffi")
if not has_ffi then return false end
